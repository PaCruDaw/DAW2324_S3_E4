...
<div class="d-flex justify-content-end mt-2">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#?lang=esp"><i class="fas fa-flag"></i> Español</a></li>
            <li><a class="dropdown-item" href="#?lang=en"><i class="fas fa-flag"></i> Inglés</a></li>
            <li><a class="dropdown-item" href="#?lang=cat"><i class="fas fa-flag"></i> Catalán</a></li>
            <li><a class="dropdown-item" href="#?lang=it"><i class="fas fa-flag"></i> Italiano</a></li>
        </ul>
    </div>
</div>
    <div class="sidebar">
        ...
        <ul>
            <li><a href="../main.php"><i class="fas fa-home"></i><?php TranslatePage::pageTranslate('Inicio', 'sidebar')?></a></li>
